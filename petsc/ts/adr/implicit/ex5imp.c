static char help[] = "Demonstrates Pattern Formation with Reaction-Diffusion Equations, using implicit timestepping.\n";
...
PetscErrorCode DMTSComputeIJacobian(DM da,PetscReal t,Vec localU,Vec Udot,PetscReal a,Mat A,Mat BB,void *ctx)
{
  AppCtx         *appctx = (AppCtx*)ctx;     /* user-defined application context */
  PetscErrorCode ierr;
  PetscInt       i,j,Mx,My,xs,ys,xm,ym;
